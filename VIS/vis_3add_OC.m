...
% ORIENTATION VENTRAL STREAM ADD FB %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Alex Cope 2008 %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Version 1.5 %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
W_F = FEEDFORWARD_WEIGHT_ADD3;
W_B = FEEDBACK_WEIGHT_ADD3;
W_R = RECIPROCAL_WEIGHT_ADD3;
W_I = FEATURE_INHIBITION_ADD3;
...
projState.norm = 'none';
projState.position = 2;
vis = nw_modAddProj(vis, fS, 'ITfb', 'n2_IT', W_B, [p2p 'mux'], projState, 'add');
projState.position = 3;
vis = nw_modAddProj(vis, fS, 'ITfb', 'n3_IT', W_B, [p2p 'mux'], projState, 'add');
projState.position = 4;
vis = nw_modAddProj(vis, fS, 'ITfb', 'n5_IT', W_B, [p2p 'mux'], projState, 'add');
projState.position = 5;
vis = nw_modAddProj(vis, fS, 'ITfb', 'n6_IT', W_B, [p2p 'mux'], projState, 'add');
projState.position = 6;
vis = nw_modAddProj(vis, fS, 'ITfb', 'n8_IT', W_B, [p2p 'mux'], projState, 'add');
projState.position = 7;
vis = nw_modAddProj(vis, fS, 'ITfb', 'n9_IT', W_B, [p2p 'mux'], projState, 'add');
projState.position = 8;
vis = nw_modAddProj(vis, fS, 'ITfb', 'o_V4', W_B, [p2p 'mux'], projState, 'add');
projState.position = 9;
vis = nw_modAddProj(vis, fS, 'ITfb', 'c_V4', W_B, [p2p 'mux'], projState, 'add');
projState.position = 10;
vis = nw_modAddProj(vis, fS, 'ITfb', 'Rc_V4', W_B, [p2p 'mux'], projState, 'add');
...
vis = nw_modAddProj(vis, fS, 'n8_IT', 'o_V4', W_B/2, [p2p 'gaussian'], projState, 'add');
vis = nw_modAddProj(vis, fS, 'n3_IT', 'Rc_V4', W_B/2, [p2p 'gaussian'], projState, 'add');
vis = nw_modAddProj(vis, fS, 'n9_IT', 'o_V4', W_B/2, [p2p 'gaussian'], projState, 'add');
vis = nw_modAddProj(vis, fS, 'n9_IT', 'Rc_V4', W_B/2, [p2p 'gaussian'], projState, 'add');
vis = nw_modAddProj(vis, fS, 'n6_IT', 'o_V4', W_B/2, [p2p 'gaussian'], projState, 'add');
vis = nw_modAddProj(vis, fS, 'n6_IT', 'c_V4', W_B/2, [p2p 'gaussian'], projState, 'add');
vis = nw_modAddProj(vis, fS, 'n5_IT', 'c_V4', W_B/2, [p2p 'gaussian'], projState, 'add');
vis = nw_modAddProj(vis, fS, 'n5_IT', 'Rc_V4', W_B/2, [p2p 'gaussian'], projState, 'add');
vis = nw_modAddProj(vis, fS, 'n2_IT', 'c_V4', W_B/2, [p2p 'gaussian'], projState, 'add');
vis = nw_modAddProj(vis, fS, 'n2_IT', 'Rc_V4', W_B/2, [p2p 'gaussian'], projState, 'add');

%% %%%%% V2
projState.sigma = 3;

vis = nw_modAddProj(vis, fS, 'o_V4', 'TR_V2', W_B/4, [p2p 'gaussian'], projState, 'add');
vis = nw_modAddProj(vis, fS, 'o_V4', 'BR_V2', W_B/4, [p2p 'gaussian'], projState, 'add');
vis = nw_modAddProj(vis, fS, 'o_V4', 'TL_V2', W_B/4, [p2p 'gaussian'], projState, 'add');
vis = nw_modAddProj(vis, fS, 'o_V4', 'BL_V2', W_B/4, [p2p 'gaussian'], projState, 'add');

vis = nw_modAddProj(vis, fS, 'c_V4', 'TL_V2', W_B/3, [p2p 'gaussian'], projState, 'add');
vis = nw_modAddProj(vis, fS, 'c_V4', 'BL_V2', W_B/3, [p2p 'gaussian'], projState, 'add');
vis = nw_modAddProj(vis, fS, 'c_V4', 'H_V2', W_B/8, [p2p 'gaussian'], projState, 'add');

vis = nw_modAddProj(vis, fS, 'Rc_V4', 'TR_V2', W_B/3, [p2p 'gaussian'], projState, 'add');
vis = nw_modAddProj(vis, fS, 'Rc_V4', 'BR_V2', W_B/3, [p2p 'gaussian'], projState, 'add');
vis = nw_modAddProj(vis, fS, 'Rc_V4', 'H_V2', W_B/8, [p2p 'gaussian'], projState, 'add');
