...
projState.E_2 = CMF_E2;
projState.M_f = CMF_Mf;
...
projState.offset = [1.0 0.0].*offCrnr;
projState.norm = 'aff';
vis = nw_modAddProjMult(vis, fS, 'V_V1m', {'BR_V2' 'BL_V2'}, normF* W_F/2, [p2p 'gaussianLPF'], projState, 'add');
%vis = nw_modAddProj(vis, fS, 'V_V1m', 'BL_V2', normF* W_F/2, [p2p 'gaussianLPF'], projState, 'add');

projState.offset = [-1.0 0.0].*offCrnr;
vis = nw_modAddProjMult(vis, fS, 'V_V1m', {'TR_V2' 'TL_V2'}, normF* W_F/2, [p2p 'gaussianLPF'], projState, 'add');
%vis = nw_modAddProj(vis, fS, 'V_V1m', 'TL_V2',  normF*W_F/2, [p2p 'gaussianLPF'], projState, 'add');

projState.offset = [0.0 -1.0].*offCrnr;
...
%vis = nw_modAddProj(vis, fS, 'H_V1m', 'H_V2', W_F/2, [p2p 'gaussianF'], projState, 'add');
...
%vis = nw_modAddProj(vis, fS, 'H_V1m', 'BR_V2',  normF*W_F/2, [p2p 'gaussianLPF'], projState, 'add');
%vis = nw_modAddProj(vis, fS, 'H_V1m', 'H_V2', W_F/2, [p2p 'gaussianF'], projState, 'add');
vis = nw_modAddProj(vis, fS, 'H_V1m', 'H_V2',  normF*W_F/1.5, [p2p 'gaussianLPF'], projState, 'add');
...
projState.E_2 = 2.5/degrees_to_edge*(in_layer_size/2);
projState.M_f = in_layer_size/(projState.E_2*log(1+(degrees_to_edge/projState.E_2)));
...
projState.offset = [-1 1.0].*factor1;
...
projState.offset = [1.0 -1].*factor1;
...
projState.sigma = 0.9;
projState.offset = [0.5 0];
projState.norm = 'aff';
normF = 1;
vis = nw_modAddProjMult(vis, fS, 'o_V4m', {'n8_IT' 'n9_IT'}, W_F/2 *normF, [p2p 'gaussianLPF'], projState, 'add');
%vis = nw_modAddProj(vis, fS, 'o_V4m', 'n9_IT', W_F/2*normF, [p2p 'gaussianLPF'], projState, 'add');
vis = nw_modAddProjMult(vis, fS, 'Rc_V4m', {'n3_IT' 'n2_IT'}, W_F/2*normF, [p2p 'gaussianLPF'], projState, 'add');
%vis = nw_modAddProj(vis, fS, 'Rc_V4m', 'n2_IT', W_F/2*normF, [p2p 'gaussianLPF'], projState, 'add');
vis = nw_modAddProjMult(vis, fS, 'c_V4m', {'n6_IT' 'n5_IT'}, W_F/2*normF, [p2p 'gaussianLPF'], projState, 'add');
%vis = nw_modAddProj(vis, fS, 'c_V4m', 'n5_IT', W_F/2*normF, [p2p 'gaussianLPF'], projState, 'add');


projState.offset = [-0.5 0];
vis = nw_modAddProj(vis, fS, 'Rc_V4m', 'n9_IT', W_F/2*normF, [p2p 'gaussianLPF'], projState, 'add');
vis = nw_modAddProj(vis, fS, 'c_V4m', 'n2_IT', W_F/2*normF, [p2p 'gaussianLPF'], projState, 'add');
vis = nw_modAddProj(vis, fS, 'Rc_V4m', 'n5_IT', W_F/2*normF, [p2p 'gaussianLPF'], projState, 'add');
vis = nw_modAddProj(vis, fS, 'o_V4m', 'n6_IT', W_F/2*normF, [p2p 'gaussianLPF'], projState, 'add');

 projState.offset = [-0.75 0];
vis = nw_modAddProj(vis, fS, 'Rc_V4m', 'n3_IT', W_F/3*normF, [p2p 'gaussianLPF'], projState, 'add');
vis = nw_modAddProj(vis, fS, 'o_V4m', 'n8_IT', W_F/3*normF, [p2p 'gaussianLPF'], projState, 'add');
...
%vis = nw_modAddProj(vis, fS, 'n9_ITb', 'Rc_V4b', W_B/2, [p2p 'gaussianIIR'], projState, 'shunt');

vis = nw_modAddProjMult(vis, fS, 'n6_ITb', {'o_V4b' 'c_V4b'}, W_B/2, [p2p 'gaussianIIR'], projState, 'shunt');
%vis = nw_modAddProj(vis, fS, 'n6_ITb', 'c_V4b', W_B/2, [p2p 'gaussianIIR'], projState, 'shunt');

vis = nw_modAddProjMult(vis, fS, 'n5_ITb', {'c_V4b' 'Rc_V4b'}, W_B/2, [p2p 'gaussianIIR'], projState, 'shunt');
%vis = nw_modAddProj(vis, fS, 'n5_ITb', 'Rc_V4b', W_B/2, [p2p 'gaussianIIR'], projState, 'shunt');

vis = nw_modAddProjMult(vis, fS, 'n2_ITb', {'c_V4b' 'Rc_V4b'}, W_B/2, [p2p 'gaussianIIR'], projState, 'shunt');
%vis = nw_modAddProj(vis, fS, 'n2_ITb', 'Rc_V4b', W_B/2, [p2p 'gaussianIIR'], projState, 'shunt');
...
% vis = nw_modAddProj(vis, fS, 'o_V4b', 'BR_V2b', W_B/4, [p2p 'gaussianIIR'], projState, 'shunt');
% vis = nw_modAddProj(vis, fS, 'o_V4b', 'TL_V2b', W_B/4, [p2p 'gaussianIIR'], projState, 'shunt');
% vis = nw_modAddProj(vis, fS, 'o_V4b', 'BL_V2b', W_B/4, [p2p 'gaussianIIR'], projState, 'shunt');

vis = nw_modAddProjMult(vis, fS, 'c_V4b', {'TL_V2b' 'BL_V2b'}, W_B/3, [p2p 'gaussianIIR'], projState, 'shunt');
% vis = nw_modAddProj(vis, fS, 'c_V4b', 'BL_V2b', W_B/3, [p2p 'gaussianIIR'], projState, 'shunt');
...
% vis = nw_modAddProj(vis, fS, 'Rc_V4b', 'BR_V2b', W_B/3, [p2p 'gaussianIIR'], projState, 'shunt');
