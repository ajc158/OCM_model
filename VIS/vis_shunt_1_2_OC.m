...
vis = nw_modAddProj(vis, fS, 'RG_V4', 'R_V1', W_B/2, [p2p 'discMax'], projState, 'shunt');
vis = nw_modAddProj(vis, fS, 'GB_V4', 'G_V1', W_B/2, [p2p 'discMax'], projState, 'shunt');
vis = nw_modAddProj(vis, fS, 'BR_V4', 'B_V1', W_B/2, [p2p 'discMax'], projState, 'shunt');

vis = nw_modAddProj(vis, fS, 'RG_V4', 'G_V1', W_B/2, [p2p 'discMax'], projState, 'shunt');
vis = nw_modAddProj(vis, fS, 'GB_V4', 'B_V1', W_B/2, [p2p 'discMax'], projState, 'shunt');
vis = nw_modAddProj(vis, fS, 'BR_V4', 'R_V1', W_B/2, [p2p 'discMax'], projState, 'shunt');
%%%

vis = nw_modAddProj(vis, fS, 'R_V4', 'R_V1', W_B, [p2p 'discMax'], projState, 'shunt');
vis = nw_modAddProj(vis, fS, 'G_V4', 'G_V1', W_B, [p2p 'discMax'], projState, 'shunt');
vis = nw_modAddProj(vis, fS, 'B_V4', 'B_V1', W_B, [p2p 'discMax'], projState, 'shunt');
...
projState.position = 1;
vis = nw_modAddProj(vis, fS, 'ITfb', 'RG_V4', W_B, [p2p 'mux'], projState, 'shunt');
projState.position = 2;
vis = nw_modAddProj(vis, fS, 'ITfb', 'GB_V4', W_B, [p2p 'mux'], projState, 'shunt');
projState.position = 3;
vis = nw_modAddProj(vis, fS, 'ITfb', 'BR_V4', W_B, [p2p 'mux'], projState, 'shunt');
projState.position = 4;
vis = nw_modAddProj(vis, fS, 'ITfb', 'R_V4', W_B, [p2p 'mux'], projState, 'shunt');
projState.position = 5;
vis = nw_modAddProj(vis, fS, 'ITfb', 'G_V4', W_B, [p2p 'mux'], projState, 'shunt');
projState.position = 6;
vis = nw_modAddProj(vis, fS, 'ITfb', 'B_V4', W_B, [p2p 'mux'], projState, 'shunt');



% and output feature map

vis = nw_modAddProj(vis, fS, 'R_V1', 'LIP', 1, [p2p 'onetoone'], projState, 'add');
vis = nw_modAddProj(vis, fS, 'G_V1', 'LIP', 1, [p2p 'onetoone'], projState, 'add');
vis = nw_modAddProj(vis, fS, 'B_V1', 'LIP', 1, [p2p 'onetoone'], projState, 'add');
