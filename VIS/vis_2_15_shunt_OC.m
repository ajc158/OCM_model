...
W_F = FEEDFORWARD_WEIGHT_SHUNT;
W_B = FEEDBACK_WEIGHT_SHUNT;
W_R = RECIPROCAL_WEIGHT_SHUNT;
%  
...
w_inh_v1=FEATURE_INHIBITION_SHUNT;

w_for_v1 = W_F;%0.19;
w_inh_v4 = FEATURE_INHIBITION_SHUNT;
...
actState = [];
actState.tau_membrane = single(0.02);
actState.p = 1;
...
vis = nw_modAddProj(vis, fS, 'RG_V4', 'R_V1', w_bac_v2, [p2p 'gaussian'], projState, 'shunt');
vis = nw_modAddProj(vis, fS, 'GB_V4', 'G_V1', w_bac_v2, [p2p 'gaussian'], projState, 'shunt');
vis = nw_modAddProj(vis, fS, 'BR_V4', 'B_V1', w_bac_v2, [p2p 'gaussian'], projState, 'shunt');

vis = nw_modAddProj(vis, fS, 'R_V4', 'R_V1', W_B, [p2p 'gaussian'], projState, 'shunt');
vis = nw_modAddProj(vis, fS, 'G_V4', 'G_V1', W_B, [p2p 'gaussian'], projState, 'shunt');
vis = nw_modAddProj(vis, fS, 'B_V4', 'B_V1', W_B, [p2p 'gaussian'], projState, 'shunt');

vis = nw_modAddProj(vis, fS, 'RG_V4', 'G_V1', w_bac_v2, [p2p 'gaussian'], projState, 'shunt');
vis = nw_modAddProj(vis, fS, 'GB_V4', 'B_V1', w_bac_v2, [p2p 'gaussian'], projState, 'shunt');
vis = nw_modAddProj(vis, fS, 'BR_V4', 'R_V1', w_bac_v2, [p2p 'gaussian'], projState, 'shunt');
...
projState.position = 1;
vis = nw_modAddProj(vis, fS, 'ITfb', 'RG_V4', w_bac_v4, [p2p 'mux'], projState, 'shunt');
projState.position = 2;
vis = nw_modAddProj(vis, fS, 'ITfb', 'GB_V4', w_bac_v4, [p2p 'mux'], projState, 'shunt');
projState.position = 3;
vis = nw_modAddProj(vis, fS, 'ITfb', 'BR_V4', w_bac_v4, [p2p 'mux'], projState, 'shunt');
projState.position = 4;
vis = nw_modAddProj(vis, fS, 'ITfb', 'R_V4', w_bac_v4, [p2p 'mux'], projState, 'shunt');
projState.position = 5;
vis = nw_modAddProj(vis, fS, 'ITfb', 'G_V4', w_bac_v4, [p2p 'mux'], projState, 'shunt');
projState.position = 6;
vis = nw_modAddProj(vis, fS, 'ITfb', 'B_V4', w_bac_v4, [p2p 'mux'], projState, 'shunt');

% and output feature map

vis = nw_modAddProj(vis, fS, 'R_V1', 'LIP', 0.3, [p2p 'onetoone'], projState, 'add');
vis = nw_modAddProj(vis, fS, 'G_V1', 'LIP', 0.3, [p2p 'onetoone'], projState, 'add');
vis = nw_modAddProj(vis, fS, 'B_V1', 'LIP', 0.3, [p2p 'onetoone'], projState, 'add');
...
% end scope
        ...
        %vis = nw_modAddInput(vis, fS, 'src>out', 'ITfb', 1.0, [p2p 'onetoone'], projState, 'shunt');
