...
vis = nw_modAddProjZD(vis, fS/10, 'V_V1m', 'V_V2', W_F/2, [p2p 'gaussianIIR'], projState, 'add');
...
for i = 1:size(elements,2)
    eval(['vis = nw_modAddProjZD(vis, fS/10, ''' cell2mat(elements(i)) ''',''' cell2mat(elements(i)) 'm'', W_F, [p2p ''discMax''], projState, ''add'');']);
...
%     eval(['vis = nw_modAddProjZD(vis, fS/10, ''' cell2mat(elements(i)) 'b'',''' cell2mat(elements(i)) ''', W_A, [p2p ''onetoone''], projState, ''add'');']);
    for j = 1:size(elements,2)
        if i ~= j
%             eval(['vis = nw_modAddProjZD(vis, fS/10, ''' cell2mat(elements(i)) ''',''' cell2mat(elements(j)) ''', W_I./(5/3), [p2p ''onetoone''], projState, ''add'');']);
        end
    end
end
...
vis = nw_modAddProjZD(vis, fS/10, 'TL_V2m', 'o_V4', W_F/oFactor, [p2p 'gaussianIIR'], projState, 'add');
vis = nw_modAddProjZD(vis, fS/10, 'TL_V2m', 'c_V4', W_F/3, [p2p 'gaussianIIR'], projState, 'add');

projState.offset = [0 0];
vis = nw_modAddProjZD(vis, fS/10, 'BL_V2m', 'o_V4', W_F/oFactor, [p2p 'gaussianIIR'], projState, 'add');
vis = nw_modAddProjZD(vis, fS/10, 'BL_V2m', 'c_V4', W_F/3, [p2p 'gaussianIIR'], projState, 'add');

projState.offset = [0 0];
vis = nw_modAddProjZD(vis, fS/10, 'TR_V2m', 'o_V4', W_F/oFactor, [p2p 'gaussianIIR'], projState, 'add');
vis = nw_modAddProjZD(vis, fS/10, 'TR_V2m', 'Rc_V4', W_F/3, [p2p 'gaussianIIR'], projState, 'add');

projState.offset = [0 0];
vis = nw_modAddProjZD(vis, fS/10, 'BR_V2m', 'o_V4', W_F/oFactor, [p2p 'gaussianIIR'], projState, 'add');
vis = nw_modAddProjZD(vis, fS/10, 'BR_V2m', 'Rc_V4', W_F/3, [p2p 'gaussianIIR'], projState, 'add');

projState.sigma = [1 0.2];
projState.offset = [1.5 0.5];
vis = nw_modAddProjZD(vis, fS/10, 'V_V2m', 'Rc_V4', -W_F, [p2p 'gaussianIIR'], projState, 'add');

projState.offset = [-1.5 0.5];
vis = nw_modAddProjZD(vis, fS/10, 'V_V2m', 'c_V4', -W_F, [p2p 'gaussianIIR'], projState, 'add');
...
%     eval(['vis = nw_modAddProjZD(vis, fS/10, ''' cell2mat(elements(i)) 'b'',''' cell2mat(elements(i)) ''', W_A, [p2p ''onetoone''], projState, ''add'');']);
    ...
    for j = 1:size(elements,2)
        if i ~= j
            projState.sigma = 0.5;
            projState.norm = 'affx';
%             eval(['vis = nw_modAddProjZD(vis, fS/10, ''' cell2mat(elements(i)) ''',''' cell2mat(elements(j)) ''', W_I, [p2p ''onetoone''], projState, ''add'');']);
        end
    end
end
...
vis = nw_modAddProjZD(vis, fS/10, 'o_V4m', 'o_IT', W_F*0.38, [p2p 'onetoone'], projState, 'add');
...
projState.offset = [0 0];
projState.norm = 'affx';
vis = nw_modAddProjZD(vis, fS/10, 'o_V4m', 'n8_IT', W_F/2, [p2p 'onetoone'], projState, 'add');
vis = nw_modAddProjZD(vis, fS/10, 'o_V4m', 'n9_IT', W_F/2, [p2p 'onetoone'], projState, 'add');
vis = nw_modAddProjZD(vis, fS/10, 'Rc_V4m', 'n3_IT', W_F/2, [p2p 'onetoone'], projState, 'add');
vis = nw_modAddProjZD(vis, fS/10, 'c_V4m', 'n6_IT', W_F/2.6, [p2p 'onetoone'], projState, 'add');
vis = nw_modAddProjZD(vis, fS/10, 'c_V4m', 'n5_IT', W_F/2, [p2p 'onetoone'], projState, 'add');
vis = nw_modAddProjZD(vis, fS/10, 'Rc_V4m', 'n2_IT', W_F/2, [p2p 'onetoone'], projState, 'add');

projState.offset = [0 0];
vis = nw_modAddProjZD(vis, fS/10, 'Rc_V4m', 'n9_IT', W_F/2, [p2p 'onetoone'], projState, 'add');
vis = nw_modAddProjZD(vis, fS/10, 'c_V4m', 'n2_IT', W_F/2, [p2p 'onetoone'], projState, 'add');
vis = nw_modAddProjZD(vis, fS/10, 'Rc_V4m', 'n5_IT', W_F/2, [p2p 'onetoone'], projState, 'add');
vis = nw_modAddProjZD(vis, fS/10, 'o_V4m', 'n6_IT', W_F/2.6, [p2p 'onetoone'], projState, 'add');
...
vis = nw_modAddProjZD(vis, fS/10, 'o_V4', 'o_V4b', 1, [p2p 'onetoone'], projState, 'add');

projState = [];
projState.norm = 'none';
projState.radius = 4;
 
vis = nw_modAddProjZD(vis, fS/10, 'n8_ITb', 'o_V4b', W_B/2, [p2p 'discMax'], projState, 'shunt');

vis = nw_modAddProjZD(vis, fS/10, 'n3_ITb', 'Rc_V4b', W_B/2, [p2p 'discMax'], projState, 'shunt');
vis = nw_modAddProjMultZD(vis, fS/10, 'n9_ITb', {'o_V4b' 'Rc_V4b'}, W_B/2, [p2p 'discMax'], projState, 'shunt');
vis = nw_modAddProjMultZD(vis, fS/10, 'n6_ITb', {'o_V4b' 'c_V4b'}, W_B/2, [p2p 'discMax'], projState, 'shunt');
...
vis = nw_modAddProjZD(vis, fS/10, 'o_ITb', 'o_V4b', W_B, [p2p 'discMax'], projState, 'shunt');
...
projState.radius = 8;
if cal == false
    vis = nw_modAddProjMultZD(vis, fS/10, 'o_V4b', {'TR_V2b' 'BR_V2b' 'TL_V2b' 'BL_V2b'}, W_B/4, [p2p 'discMax'], projState, 'shunt');
