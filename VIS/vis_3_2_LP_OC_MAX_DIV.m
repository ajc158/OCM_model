...
vis = nw_modAddProj(vis, fS, 'o_V4m', 'o_IT', W_F, [p2p 'onetoone'], projState, 'add');
vis = nw_modAddProj(vis, fS, 'Rc_V4m', 'Rc_IT', W_F, [p2p 'onetoone'], projState, 'add');
vis = nw_modAddProj(vis, fS, 'c_V4m', 'c_IT', W_F, [p2p 'onetoone'], projState, 'add');
...
projState.position = 8;
vis = nw_modAddProj(vis, fS, 'ITfb', 'o_ITb', W_B/1, [p2p 'mux'], projState, 'shunt');
projState.position = 9;
vis = nw_modAddProj(vis, fS, 'ITfb', 'c_ITb', W_B/1, [p2p 'mux'], projState, 'shunt');
projState.position = 10;
vis = nw_modAddProj(vis, fS, 'ITfb', 'Rc_ITb', W_B/1, [p2p 'mux'], projState, 'shunt');
...
vis = nw_modAddProj(vis, fS, 'n8_ITb', 'o_V4b', W_B/2, [p2p 'discMax'], projState, 'shunt');
vis = nw_modAddProj(vis, fS, 'n3_ITb', 'Rc_V4b', W_B/2, [p2p 'discMax'], projState, 'shunt');

vis = nw_modAddProjMult(vis, fS, 'n9_ITb', {'o_V4b' 'Rc_V4b'}, W_B/2, [p2p 'discMax'], projState, 'shunt');

vis = nw_modAddProjMult(vis, fS, 'n6_ITb', {'o_V4b' 'c_V4b'}, W_B/2, [p2p 'discMax'], projState, 'shunt');

vis = nw_modAddProjMult(vis, fS, 'n5_ITb', {'c_V4b' 'Rc_V4b'}, W_B/2, [p2p 'discMax'], projState, 'shunt');

vis = nw_modAddProjMult(vis, fS, 'n2_ITb', {'c_V4b' 'Rc_V4b'}, W_B/2, [p2p 'discMax'], projState, 'shunt');

vis = nw_modAddProj(vis, fS, 'Rc_ITb', 'Rc_V4b', W_B, [p2p 'discMax'], projState, 'shunt');
vis = nw_modAddProj(vis, fS, 'c_ITb', 'c_V4b', W_B, [p2p 'discMax'], projState, 'shunt');
vis = nw_modAddProj(vis, fS, 'o_ITb', 'o_V4b', W_B, [p2p 'discMax'], projState, 'shunt');
...
vis = nw_modAddProjMult(vis, fS, 'o_V4b', {'TR_V2b' 'BR_V2b' 'TL_V2b' 'BL_V2b'}, W_B/4, [p2p 'discMax'], projState, 'shunt');

vis = nw_modAddProjMult(vis, fS, 'c_V4b', {'TL_V2b' 'BL_V2b'}, W_B/3, [p2p 'discMax'], projState, 'shunt');
vis = nw_modAddProj(vis, fS, 'c_V4b', 'H_V2b', W_B/8, [p2p 'discMax'], projState, 'shunt');

vis = nw_modAddProjMult(vis, fS, 'Rc_V4b', {'TR_V2b' 'BR_V2b'}, W_B/3, [p2p 'discMax'], projState, 'shunt');
vis = nw_modAddProj(vis, fS, 'Rc_V4b', 'H_V2b', W_B/8, [p2p 'discMax'], projState, 'shunt');
...
if scopeOn==true
    ...
    for i = 1:size(elements,2)
        ...
        eval(['vis = vis.link(''' cell2mat(elements(i)) 'b/out>out'', ''scope' num2str(i) '<<mono<in'');']);
    end
    ...
    for i = 1:size(elements,2)
        ...
        eval(['vis = vis.link(''' cell2mat(elements(i)) 'b/out>out'', ''scope2_' num2str(i) '<<mono<in'');']);
    end
