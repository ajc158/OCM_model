...
elements = {'H_V2' 'V_V2' 'TL_V2' 'TR_V2' 'BL_V2' 'BR_V2'};
...
vis = nw_modAddProj(vis, fS, 'H_V2m', 'IT', W_F, [p2p 'muxMax'], projState, 'add');
projState.position = 10;
vis = nw_modAddProj(vis, fS, 'V_V2m', 'IT', W_F, [p2p 'muxMax'], projState, 'add');
...
projState.position = 9;
vis = nw_modAddProj(vis, fS, 'ITfb', 'H_V2b', W_B/6, [p2p 'mux'], projState, 'shunt');
projState.position = 10;
vis = nw_modAddProj(vis, fS, 'ITfb', 'V_V2b', W_B/6, [p2p 'mux'], projState, 'shunt');
